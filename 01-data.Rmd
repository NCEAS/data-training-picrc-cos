...
1. [Learning Objectives](#working-with-data-learning-objectives)
1. [Value Statement](#working-with-data-value-statement)
1. [File naming](#file-naming)
1. [Creating a Working Folder Structure](#Creating-a-working-folder-structure)
1. [Metadata](#metadata)
1. [Version control](#version-control)
1. [Summary](#data-management-summary)
...
1. Along with this class, we provided you with a metadata template, downloadable [here](files/meatadata_template_blank.xlsx). Please notice that this template can be adjusted to reflect your organization’s needs, therefore some of the requested information might change accordingly. Below, you will find an example of a filled out metadata template for the data that we will be using in Module 3.
...
3. Much has been written on effective data management to enable reuse of data. The following two papers offer words of wisdom:
    - [Some simple guidelines for effective data management. Borer et al. 2009. Bulletin of the Ecological Society of America](https://www.jstor.org/stable/bullecosociamer.90.2.205).
    - [Nine simple ways to make it easier to (re)use your data. White et al. 2013. Ideas in Ecology and Evolution 6](https://ojs.library.queensu.ca/index.php/IEE/article/view/4608).
...
1. Time to practice with an untidy data set! Use what you’ve learned about data cleaning to normalize and standardize the data set [here](files/M2S2_exercise.xlsx). See the tidied version [here](files/M2S3_exercise_key.xlsx).
