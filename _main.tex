...
\hypersetup{
  ...
  pdfauthor={Stanford Center for Ocean Solutions; Palau International Coral Reef Center; National Center for Ecological Analysis and Synthesis},
  hidelinks,
...
\author{Stanford Center for Ocean Solutions \and Palau International Coral Reef Center \and National Center for Ecological Analysis and Synthesis}
\date{2022-01-12}
...
\item
  ...
  \item
    ...
    \item
      ...
      \end{itemize}
    \item
      \emph{The information provided under Data Layers only applies to the United States. }
    \end{itemize}
  \item
