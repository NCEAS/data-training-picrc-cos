...
1. The first step in effective data storytelling is to ensure you are working with clean, standardized data:
   - This section assumes that the data you have to tell stories from are clean and standardized already. If your data are still raw and not cleaned, please refer to *Module 2* in this training curriculum, titled *“Data”* to learn more about how to clean and standardize your data set.
...
Distilled details with the key messages from this module are in this downloadable [brief](files/M4S2_Data_Storytelling_Brief.pdf), to be used as a reference guide.
