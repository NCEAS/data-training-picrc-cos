...
1. [Convert units using Calculated Fields](#convert-unites-using-calculated-fields)
1. [Manually calculate average](#manually-calculate-average)
1. [More functions](#more-funtions)
...
1. [Learning objectives](#basic-dashboards-learning-objetives)
