...
1. Learn how to connect data sets to Tableau interface
...
(b) This column on the left is where you will load data. 
...
1. Download this file: CRM_Fish_edit and save it in the “Tableau Data Training” folder
...
1. [Value Statement](#value-statement)
...
1. *For this session we recommend that, if possible, have two screens open—one with Tableau and one with the course material—so you can follow along with the exercises.*
...
1. Practice Exercise: Create and modify a **Line Plot**
    ...
    - Drag **Year** into **Columns** and drag **Biomass** into **Rows**.
...
1. Check your work by comparing it with this file.
...
1. Value statement
1. Multiple factor plots using the Marks menu
...
3. Create a bar plot with multiple factors
...
4. Create a timeseries with multiple factors
...
5. Create a scatter plot with multiple factors
...
6. Create a bar plot using continuous data
    ...
    - Then sort Species from highest to lowest Size. Right-click the **Species** field in Columns. Choose **Sort**. 
...
1. There are three conditions to keep in mind when you create a table in Tableau:
  (1) Data should be dragged into Rows because we are following a long format. 
    - Refer to Module 2 to learn more about long versus block format
  (2) Everything has to be discrete because the software will always attempt to plot continuous data as a chart, not as text. 
  (3) You can use filters, sort, and all the other functionalities that you learned for other types of plots. Tables in Tableau are similar to dynamic tables in Excel.      
...
1. Learning objectives
1. Value statement
1. Convert units using Calculated Fields
1. Manually calculate average
1. More functions
1. Table calculations: percentage of total and running total
1. Conclusions
...
<iframe width="560" height="425" src="files/M3S4_calculated_field_biomass_example.pdf" frameborder="0" allowfullscreen></iframe>
...
3. Next, follow along as Alfredo shows you how to calculate percentages of total and display them in the labels
...
4. Just like with Calculated Fields, Table Calculations are a powerful tool in Tableau’s repository. If you want to explore more resources, go to:
...
1. Floating dashboards
1. Actions: filter and highlight
1. Conclusions
1. Homework
...
1. Explore how to make differents charts interact with each other through dashboard actions
...
1. Learning objectives
1. Recap: Tooltip customization and exact colors
1. Background images
1. Custom shapes
1. Filters in dashboards
...
1. Before you begin this section, download this folder of images and save it to your desktop folder “Tableau Data Training” 
...
1. So far, we have focused on using sheets to filter each other when together in a dashboard. However, sometimes we might want to use a field (not a sheet) to filter the information in the whole dashboard. 1. Below, you will find an example of how to do this.
...
1. Learning objectives
1. Value statement
1. Saving your work and your datasets
1. Sharing your work
1. Embedding into a website
1. Summary
